...
namespace RebecaBarrezueta1004WebApplication1.Controllers
{
    public class PromoRBController : Controller
    {
        ...
        public PromoRBController(RebecaBarrezueta1004WebApplication1Context context)
        {
            _context = context;
        }
        ...
        {
            var rebecaBarrezueta1004WebApplication1Context = _context.Promo.Include(p => p.Burguer);
            return View(await rebecaBarrezueta1004WebApplication1Context.ToListAsync());
        }
